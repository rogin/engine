...
public class DefaultNotificationProviderTest {
    ...
    public void test_jsonStreamPopulated() throws Exception {
        ...
        Stream<JsonNode> stream = new DefaultNotificationProvider().toJsonStream(entity);
    ...
    public void test_getResponseContent() throws Exception {
        ...
        String content = new DefaultNotificationProvider().getResponseContent(entity);
    ...
    public void test_getCharsetWhenMissing() throws Exception {
        HttpEntity entity = createEntityFromFile(FILE_POPULATED);
        Charset charset = new DefaultNotificationProvider().getCharset(entity);
    ...
    public void test_currentIsOlderMajorVersion() throws Exception {
        ...
        assertTrue(new DefaultNotificationProvider().isCurrentOlderThan(current, "4.0.0"));
    }

    @Test
    public void test_currentIsNewerMajorVersion() throws Exception {
        Version current = Version.parse("4.0.0");
        assertFalse(new DefaultNotificationProvider().isCurrentOlderThan(current, "3.12.0"));
    }

    @Test
    public void test_currentIsSameVersion() throws Exception {
        Version current = Version.parse("4.0.0");
        assertFalse(new DefaultNotificationProvider().isCurrentOlderThan(current, "4.0.0"));
    }

    @Test
    public void test_currentIsOlderMinor() throws Exception {
        Version current = Version.parse("4.0.1");
        assertTrue(new DefaultNotificationProvider().isCurrentOlderThan(current, "4.1.1"));
    }

    @Test
    public void test_currentIsNewerMinor() throws Exception {
        Version current = Version.parse("4.1.1");
        assertFalse(new DefaultNotificationProvider().isCurrentOlderThan(current, "4.0.1"));
    }

    @Test
    public void test_currentIsOlderRevision() throws Exception {
        Version current = Version.parse("4.0.0");
        assertTrue(new DefaultNotificationProvider().isCurrentOlderThan(current, "4.0.1"));
    }
    ...
    public void test_currentIsNotOlderThanInvalidOther() throws Exception {
        Version current = Version.parse("4.0.1");
        assertFalse(new DefaultNotificationProvider().isCurrentOlderThan(current, "INVALID_VERSION_STRING"));
    }
    ...
    public void test_noNotificationsForCurrentVersionNewerThanAllOther() throws Exception {
        ...
        DefaultNotificationProvider provider = new DefaultNotificationProvider();
        Stream<JsonNode> notifications = provider.filterForNewerVersions(provider.toJsonStream(entity), current);
    ...
    public void test_notificationInfo() throws Exception {
        HttpEntity entity = createEntityFromFile(FILE_POPULATED);
        DefaultNotificationProvider provider = new DefaultNotificationProvider();
        Optional<JsonNode> firstNode = provider.toJsonStream(entity).findFirst();

        assertTrue("A node was expected to act upon", firstNode.isPresent());
        
        JsonNode orig = firstNode.get();

        Notification created = provider.toNotification(orig);
    ...
    @Test
    public void test_notificationContentTrim() throws Exception {
        String expected = "New release info";
        String actual = new DefaultNotificationProvider().toNotificationContent(expected + "\r this should be trimmed");
        assertEquals(expected, actual);
    }

    @Test
    public void test_notificationContentNoTrim() throws Exception {
        String expected = "New release info";
        String actual = new DefaultNotificationProvider().toNotificationContent(expected);
        assertEquals(expected, actual);
    }
}
